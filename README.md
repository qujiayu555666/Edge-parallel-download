...
2. ![安装界面](images/image3.png)
3. 完成安装。向导会提供扩展文件夹路径，可复制路径并打开 Edge 扩展管理页。
4. 在Edge地址栏输入 `edge://extensions` 开启“开发人员模式”，选择“加载解压缩的扩展”，粘贴向导提供的路径并选择该文件夹。
5. 点击扩展图标，再点“检查连接”，看到“已连接”即可使用。
